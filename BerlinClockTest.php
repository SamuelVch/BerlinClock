...
class BerlinClockTest extends TestCase
{
    ...
    public function test_translateSeconds_given1_shouldReturn0Red() {
        $actual = $this->actTranslateSeconds(1);

        $this->assertEquals(["black"],$actual);
    }

    public function test_translateSeconds_given2_shouldReturn1Red(){
        $actual = $this->actTranslateSeconds(2);

        $this->assertEquals(["red"],$actual);
    }

    public function test_translateAllClock_given00h00m00shouldReturn1Red(){
        $input = '00:00:00';
        $date = strtotime($input);
        $actual = $this->actTranslateAllClock($date);

        $this->assertEquals(["red","black", "black", "black", "black", "black", "black", "black", "black", "black", "black", "black", "black", "black", "black", "black", "black", "black", "black", "black", "black", "black", "black", "black"],$actual);
    }

    public function test_translateAllClock_given05h00m00shouldReturn2Red(){
        $input = '05:00:00';
        $date = strtotime($input);
        $actual = $this->actTranslateAllClock($date);

        $this->assertEquals(["red", "red", "black", "black", "black", "black", "black", "black", "black", "black", "black", "black", "black", "black", "black", "black", "black", "black", "black", "black", "black", "black", "black", "black"], $actual);
    }

    public function test_translateAllClock_given18h07m00shouldReturn7RedAnd3Yellow(){
        $input = '18:07:00';
        $date = strtotime($input);
        $actual = $this->actTranslateAllClock($date);

        $this->assertEquals(["red", "red", "red", "red", "black", "red", "red", "red", "black", "yellow", "black", "black", "black", "black", "black", "black", "black", "black", "black", "black", "yellow", "yellow", "black", "black"],$actual);
    }

    public function test_translateAllClock_given19h53m47shouldReturn10RedAnd10Yellow(){
        $input = '19:53:47';
        $date = strtotime($input);
        $actual = $this->actTranslateAllClock($date);

        $this->assertEquals(["black", "red", "red", "red", "black", "red", "red", "red", "red", "yellow", "yellow", "red", "yellow", "yellow", "red", "yellow", "yellow", "red", "yellow", "black", "yellow", "yellow", "yellow", "black"],$actual);
    }
    ...
    public function actTranslateAllClock(int $date)
    {
        return $this->berlinClock->translateAllClock($date);
    }
